<!-- Use PHP to check the success query parameter -->
<?php
...
<body>
    ...
    <div class="heading" style="background: url(images/explore.jpg) no-repeat">
        <h1>book</h1>
    </div>
    ...
    <section class="booking">
        ...
        <!-- Use PHP to update the h1 tag based on the success query parameter -->
        <?php if ($success === "1"): ?>
            <h1 class="alert">Booking successful!</h1>
        <?php else: ?>
